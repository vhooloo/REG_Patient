...
<input id="statuscheck" type="checkbox" value="inactive" onclick="statusfilter(this.checked);"> Patients to be followed-up </input>
...
<input type="button" id="loadState" value="Load State" /-->
    ...
    function statusfilter(inactiveflag) {
	  ...
	  var filtergroup = new $.jqx.filter();
	  //actives;
	  var filteron = filtergroup.createfilter('stringfilter', '', 'NOT_EMPTY');
	...
	$("#jqxgrid").jqxGrid(
	{
		...
		columns: [
			...
			{ text: 'Status', filtertype: 'textbox',  datafield: 'status',  width: 140,    renderer:columnsrenderer},
